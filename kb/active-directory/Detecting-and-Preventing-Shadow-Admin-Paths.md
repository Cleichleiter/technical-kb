...
Shadow admin permissions are among the **most dangerous and least visible** risks in an AD environment because they often bypass monitoring that focuses only on privileged groups.
...
* **High** — Non-standard principals hold dangerous rights
* **Medium** — Delegation is broad but contextual
* **Informational** — Visibility is provided without judgment
...
Avoid emergency removal without understanding impact, especially in production environments.
